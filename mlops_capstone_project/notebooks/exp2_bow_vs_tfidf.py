...
CONFIG = {
    "data_path":"./data.csv",
    "test_size":0.2,
    "mlflow_tracking_uri":os.getenv("Tracking_uri"),
    "dagshub_repo_owner":os.getenv("username"),
            ...
            for vec_name,vectorizer in VECTORIZERS.items():
                with mlflow.start_run(run_name=f"{algo_name} with {vec_name}",nested=True) as child_run:
                    try:
                        ...
                        log_model_params(algo_name, model) # function defined below 
                        ...
                        print(f"Error during training and evaluation for {algo_name} with {vec_name}: {e}")
