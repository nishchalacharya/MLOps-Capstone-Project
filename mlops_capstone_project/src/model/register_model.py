...
# -------------------------------------------------------------------------------------
dagshub.init(repo_owner='nishchalacharya', repo_name='MLOps-Capstone-Project', mlflow=True)
# -------------------------------------------------------------------------------------
...
def register_model(model_name: str, model_info: dict):
    ...
    try:
        ...
        logging.info(f'Model registered successfully: {model_name} v{model_version.version}')
